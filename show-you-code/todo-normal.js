...
function renderHTML() {
  return `
        <input type="checkbox" class="selectAll" ${
          todolist.length && todolist.every((it) => it.done) ? "checked" : ""
        }>
        ...
        <p>
            ...
            } name="catorige" value="active">未完成</label>
            <label><input type="checkbox" ${
              state == "completed" ? "checked" : ""
            } name="catorige" value="completed">已完成</label>
            <label><input type="checkbox" ${
              state == "all" ? "checked" : ""
            } name="catorige" value="all">全部</label>
        </p>
    `;
}
